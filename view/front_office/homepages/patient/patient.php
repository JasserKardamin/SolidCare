					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="patient.php"><img src="img/logo.png" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
								<?php if($gender == "male") { ?>
									<h1>Welcome Mr <?php echo $name ?></span></h1>
									<p>Our dedicated team of healthcare professionals is passionately devoted to fostering an environment of trust and support, striving to go beyond medical treatment to truly enhance the overall experience for our patients</p>
									<?php } else {?>
										<h1>Welcome Mrs <?php echo $name ?></span></h1>
										<p>Our dedicated team of healthcare professionals is passionately devoted to fostering an environment of trust and support, striving to go beyond medical treatment to truly enhance the overall experience for our patients</p>
									<?php }?>
								</div>
							</div>
