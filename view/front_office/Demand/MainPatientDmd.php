...
<body>
							...
							<div class="main-menu">
								<nav class="navigation">
									<ul class="nav menu">
										...
										<li  class="active"><a href="MainPatientDmd.php">request list</a></li>
	...
	<div class="RDVS">
		...
		$final_list = $new_dmd->read_DMD_patient($cin);
		$final_list2 = $new_dmd1->read_DMD_patient_wr($cin);
		?>
					...
					foreach ($final_list2 as $dmd1) {
						...
						<tr>
							<td>
								<?php
								$cinn = $dmd1['CIN_nurse'];
								$final_list3 = $new_nurse->read_NRS_by_CIN($cinn);
