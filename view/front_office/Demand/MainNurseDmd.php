...
<body>
						...
						<div class="col-lg-7 col-md-9 col-12">
							...
							<div class="main-menu">
								...
								<ul class="nav menu">
											...
											<li class="active"><a href="MainNurseDmd.php">request list</a></li>
	...
	<div class="RDVS">
		...
		$new_dmd = new dmd();
		$new_patient = new patient();
		$final_list = $new_dmd->read_DMD_nurse($cin);
		?>

		<div class="box">
		<div class="amine">
				<h1>Your Daily Request List</h1>
					...
					foreach ($final_list as $dmd) {
						...
						<tr>
							...
							<td style='padding: 0px;'>
								<form action="../../controller/accept_or_refuse.php" method="post">
									<input type="hidden" name="ar" value="refused">
									<input type="hidden" name="id" value="<?php echo $dmd['id_dmd'] ?>">
									<button class="contact_button">
										<p class="text">Refuse</p>
									</button>
								</form>
							</td>
							<td style='padding: 0px;'>
								<form action="../../controller/accept_or_refuse.php" method="post">
									<input type="hidden" name="ar" value="accepted">
									<input type="hidden" name="id" value="<?php echo $dmd['id_dmd'] ?>">
									<input type="hidden" name="cinn" value="<?php echo $dmd['CIN_nurse'] ?>">
									<input type="hidden" name="cinp" value="<?php echo $dmd['CIN_patient'] ?>">
									<input type="hidden" name="in" value="<?php echo $dmd['infos'] ?>">
									<input type="hidden" name="dt" value="<?php echo $dmd['date'] ?>">
									<button class="contact_button">
