    ...
    <body>
		...
		<div class="profile_container">
			<div class="profile">
				<div class="navb">
					<div class="param">
						...
						<div class="set">
							...
							<a href="../profile/general.php">General</a>
						</div>
						<div  class="activee">
				...
				<div class="main">
					<h1>Privacy</h1>
					<form action="../../../../controller/front_office/modify_priv.php" class="form4" method= "post">
						<div class="lwala">
							<div class="ttt">
								<span>Email</span>
								<input type="text" name="email" placeholder="<?php echo htmlspecialchars($r['email']); ?>">
							</div>

							<div class="ttt">
								<span>Password</span>
								<input type="text" name="pass" placeholder="<?php echo htmlspecialchars($r['password']); ?>">
							</div>
						</div>
						...
						<div class="lorin">
							...
							<div class="ttt">
								...
								<input type="text" name="remail" placeholder="example@example">
							</div>
