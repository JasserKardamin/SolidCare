    ...
    <body>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="../../homepages/patient/patient.php"><img src="img/logo.png" alt="loading..."></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
                        ...
                        <div class="col-lg-2 col-12">
                            <div class="get-quote">
									<form action="../../../../controller/front_office/bookappointment.php" method = "post">
		...
		<div class="pricing-cards" id = "pricing-cards" >
			<div class="card">
				...
				<form action="../../../../controller/front_office/sub_enreg.php" method = "post">
		...
		<script>				
			...
			function callPhpFunction() {
				...
				xhr.open("GET", "../../../../controller/front_office/delete_discount.php", true);
