...
<head>
	...
	<link
		...
		rel="stylesheet">
	<link rel="stylesheet" href= "./ressources/st.css">
	<!-- Bootstrap CSS -->
...
<body>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-3 col-md-3 col-12">
							<!-- Start Logo -->
							<div class="logo">
								<a href="../homepages/patient/patient.php"><img src="./ressources/logo.png" alt="#"></a>
							</div>
							<!-- End Logo -->
							<!-- Mobile Nav -->
							...
							<div class="main-menu">
								<nav class="navigation">
									<ul class="nav menu">
										...
										<li class="active"><a style="padding: 25px 0 25px 0 ;" href="../../rdv/MainNurseRdv.php">appointment list</a></li>
						...
						<div class="col-lg-2 col-12">
								<div class="get-quote">
									...
									<a href="../profile/profile/general.php" class = "space" >
                                        <?php if ($r['photo'] == NULL) {?>
												<img  src="./homepages/public/pdp.png" alt="">
										<?php } else {?>	
	...
	<div class="RDVS">
		...
		$final_list = $new_rdv->read_RDV_patient($cinp);
		foreach ($final_list as $rdv) {
			$rdvArray[] = $rdv['date'];
		}
	    $flag = 0 ; 
		if ($searchValue != NULL) {
			$final_list = $new_rdv->search_by_first_and_last_name_of_nurse($searchValue,$cinp);
			if ($final_list == NULL) {
			$flag = 1 ; 
			}
		}
		...
		echo "<h1 class='check'>Check Your<br><span style='font-size: 80px;color:#1A76D1;'>Appointments</span></h1>";

		echo '
		<form class="sss" action="' . htmlspecialchars($_SERVER["PHP_SELF"]) . '" method="post">
			<input placeholder="Search by First or Last Name" class="input-style" type="text" name="searchValue">
					...
					foreach ($final_list as $rdv) {
						...
						<tr>
							<td>
								<?php
								$cinn = $rdv['CIN_nurse'];
								$final_list1 = $new_nurse->read_NRS_by_CIN($cinn);
