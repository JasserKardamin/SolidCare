...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		...
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="../../homepages/patient/css/bootstrap.min.css">
		<!-- Nice Select CSS -->
		<link rel="stylesheet" href="../../homepages/patient/css/nice-select.css">
		<!-- Font Awesome CSS -->
        <link rel="stylesheet" href="../../homepages/patient/css/font-awesome.min.css">
		<!-- icofont CSS -->
        <link rel="stylesheet" href="../../homepages/patient/css/icofont.css">
		<!-- Slicknav -->
		<link rel="stylesheet" href="../../homepages/patient/css/slicknav.min.css">
		<!-- Owl Carousel CSS -->
        <link rel="stylesheet" href="../../homepages/patient/css/owl-carousel.css">
		<!-- Datepicker CSS -->
		<link rel="stylesheet" href="../../homepages/patient/css/datepicker.css">
		<!-- Animate CSS -->
        <link rel="stylesheet" href="../../homepages/patient/css/animate.min.css">
		<!-- Magnific Popup CSS -->
        <link rel="stylesheet" href="../../homepages/patient/css/magnific-popup.css">
		
		<!-- Medipro CSS -->
        <link rel="stylesheet" href="../../homepages/patient/css/normalize.css">
        <link rel="stylesheet" href="../../homepages/patient/style.css">
        <link rel="stylesheet" href="../../homepages/patient/css/responsive.css">
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="../../homepages/patient/patient.php"><img src="../../homepages/patient/img/logo.png" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
							...
							<div class="col-lg-7 col-md-9 col-12">
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu" style = "width:2000px;" >
							...
							<div class="col-lg-2 col-12">
								<div class="get-quote">
									<form action="../../../../controller/front_office/bookappointment.php">
										<button type ="submit" class="btn">book an appointment<span class="material-symbols-outlined">monitor_heart</span></button>
									</form>
									<a href="../../profile/profile/general.php" class="space">
										<?php if ($r['photo'] == NULL) {?>
												<img  src="../../homepages/patient/pdp.png" alt="">
										<?php } else {?>	
...
<button style=" display: block;
  ...
  margin-right: 460px;" id="filterButton" class="btn btn-primary mt-3">
    ...
    <div class="container mt-4">
        ...
        <table id="treatmentTable" style="border : 0 px; " class="table table-striped table-bordered table-hover RdvTable ">
            <thead>
                <tr>
...
// Include your Treatment class file
...
// ... rest of your code to display treatment records in the table
    ...
    <!-- Footer Area -->
	   ...
	   <!--/ End chatbot -->
		...
		<!-- jquery Min JS -->
        <script src="../../homepages/patient/js/jquery.min.js"></script>
		<!-- jquery Migrate JS -->
		<script src="../../homepages/patient/js/jquery-migrate-3.0.0.js"></script>
		<!-- jquery Ui JS -->
		<script src="../../homepages/patient/js/jquery-ui.min.js"></script>
		<!-- Easing JS -->
        <script src="../../homepages/patient/js/easing.js"></script>
		<!-- Color JS -->
		<script src="../../homepages/patient/js/colors.js"></script>
		<!-- Popper JS -->
		<script src="../../homepages/patient/js/popper.min.js"></script>
		<!-- Bootstrap Datepicker JS -->
		<script src="../../homepages/patient/js/bootstrap-datepicker.js"></script>
		<!-- Jquery Nav JS -->
        <script src="../../homepages/patient/js/jquery.nav.js"></script>
		<!-- Slicknav JS -->
		<script src="../../homepages/patient/js/slicknav.min.js"></script>
		<!-- ScrollUp JS -->
        <script src="../../homepages/patient/js/jquery.scrollUp.min.js"></script>
		<!-- Niceselect JS -->
		<script src="../../homepages/patient/js/niceselect.js"></script>
		<!-- Tilt Jquery JS -->
		<script src="../../homepages/patient/js/tilt.jquery.min.js"></script>
		<!-- Owl Carousel JS -->
        <script src="../../homepages/patient/js/owl-carousel.js"></script>
		<!-- counterup JS -->
		<script src="../../homepages/patient/js/jquery.counterup.min.js"></script>
		<!-- Steller JS -->
		<script src="../../homepages/patient/js/steller.js"></script>
		<!-- Wow JS -->
		<script src="../../homepages/patient/js/wow.min.js"></script>
		<!-- Magnific Popup JS -->
		<script src="../../homepages/patient/js/jquery.magnific-popup.min.js"></script>
		<!-- Counter Up CDN JS -->
		<script src="http://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js"></script>
		<!-- Bootstrap JS -->
		<script src="../../homepages/patient/js/bootstrap.min.js"></script>
		<!-- Main JS -->
		<script src="../../homepages/patient/js/main.js"></script>
