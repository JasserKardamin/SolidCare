...
foreach ($treatmentRecords as $record) {
    ...
    $html .= "<td>";
    $html .= "<form method='get' action='modify_treatmentI.php'>";
    $html .= "<input type='hidden' name='id' value='{$record['id_treatment']}'>";
    $html .= "<button type='submit' name='modifyTreatment' class='btn btn-info '>Modify</button>";
    $html .= "</form>";
    $html .= "</td>";
    $html .= "</tr>";
}
